export const worksData = [
    ...
    },
    {
      ...
      point: 'いかにも素人が作ったように見せるための意図的な雑な設計と、画面にはカルパスの画像と「おやつカルパス」「おやつカルパスじゃない」というボタンが並んでいるだけの構図からなるシュールな雰囲気',
      comment: `このゲームはいわゆる「バカゲー」といわれる代物です。
      私はおやつカルパスが好きです。そこでふと、「おやつカルパスとそれ以外のカルパスを見分けるのって面白いのではないか」と思ってこのゲームの制作に乗り出しました。
      このゲームはとにかくバカゲー感を出すこととシュールな雰囲気を出すことを意識しました。
      まずゲーム画面の背景はUnityのデフォルトのカラーをそのまま使っていますし、フォントやボタンなどもデフォルトのものです。さらに、タイトル画面の文字の折り返しの箇所も意図的に中途半端にしています。
      画像に対してプレイヤーがボタンで回答した後、カルパスの画像がズームアウトして正解のカルパスが表示される演出がありますが、これもあえて元々ズームアウトされた写真を撮りズームインされた状態からズームアウトさせる処理ではなく、カルパスに近い所から引くように映像を撮影しています。
      こうすることで正解が出るときのズームアウトに手振れが出ていかにも素人が頑張って作った感が醸し出せていると思います。
      ちなみに、本作品の制作はほとんど私1人で行いましたが、BGMはサークルのメンバーに作ってもらいました。ゆる～い雰囲気が本作品の面白さを引き立てていて、楽しさを倍増させています。
      制作したゲームは全て大学祭で展示されたのですが、本作品は私が主導して作った3作品のうち、来場者に最も楽しまれた作品となりました。作品の面白さをたくさんの人と共有できたことを嬉しく思いますが、他の作品と比べて制作期間は圧倒的に短く、クオリティも意図的とはいえ低いものでしたので、ゲーム制作にかけるコストとプレイヤーにとっての面白さは必ずしも比例しないと痛感しました。
      `,
    ...
    },
    {
      ...
      job: '企画・プログラマ',
      point: 'テーブル席でレーン側に座ってしまったことで醤油や注文された寿司を渡さなければいけないという現実でもあり得そうな状況を表現。さらにマウスのドラッグ＆ドロップという簡単な操作であるものの操作の正確性によってスコアに差が出る難易度設計。',
      comment: `本作品は回転寿司がテーマのゲームです。テーブル席でレーン側に座ってしまったことで醤油や注文された寿司を渡さなければいけないというちょっと現実でもあり得そうな状況に焦点を当てています。
      自分のお寿司をたくさん取りつつ、同じテーブルにいる同行者の要求には素早く応えなければなりません。
      ...
      まだまだ不十分な部分はありますが、これまでに制作したものよりかはクオリティの高いゲームになったと思います。
      `,
    ...
    },
    {
      ...
      period: 'プロジェクト全体：およそ1年、自分が関わった部分：およそ1週間（大学4年次に制作）',
      job: '譜面制作',
    ...
    },
    {
      ...
      このプロジェクトは8名のメンバーで構成されています。HMD（ヘッドマウントディスプレイ）を利用したVRならではの新しい体験のアイデアをまずはメンバーで出し合いました。その後、メンバー以外の人からの意見もいただき、「頭が斬られる」体験が最も面白そうだということになりました。
